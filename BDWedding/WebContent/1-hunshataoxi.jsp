						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="layui-row">
      								 	 <form class="layui-form layui-col-md12 x-so" action="HunshaListServlet" method="post">
        					 				<input type="text" placeholder="请输入摄影师名字 ..." class="nav-search-input" id="nav-search-input" autocomplete="off" name="pname" />											
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">	
															<a title="查看图片"  href="3-kepianguanli.jsp">
              												...
              												<a title="编辑"  href="HunshaEditServlet?pid=<%=pg.getpId()%>" href="javascript:;">
