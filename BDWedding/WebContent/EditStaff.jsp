			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0)">修改职工信息</a>
						</li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
							<div class="step-content pos-rel" id="step-container">
										<div class="step-pane active" id="step1">
											<h3 class="lighter block blue">修改该职工信息</h3>
												<form class="form-horizontal "  action="StaffUpdateServlet" id="validation-form" method="post">
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="text" name="sid" id="sid" class="col-xs-12 col-sm-3"  readonly="readonly" value="<%=s.getsId()%>"/>
																</div>
															</div>
														</div>
														<div class="space-2"></div>
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="text" name="sname" id="sname" class="col-xs-12 col-sm-3" value="<%=s.getsName()%>" />
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="text" name="sage" id="sage" class="col-xs-12 col-sm-3" value="<%=s.getsAge()%>"/>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="text" name="ssex" id="ssex" class="col-xs-12 col-sm-3" value="<%=s.getsSex()%>"/>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="input-group">
																	...
																	<input type="text" id="spost" name="spost" class="col-xs-12 col-sm-2" value="<%=s.getsPost()%>" />
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="input-group">
																	...
																	<input type="text" id="sphone" name="sphone" class="col-xs-12 col-sm-2" value="<%=s.getsPhone()%>"/>
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="input-group">
																	...
																	<input type="text" id="swage" name="swage" class="col-xs-12 col-sm-2" value="<%=s.getsWage()%>" />
																</div>
															</div>
														</div>
