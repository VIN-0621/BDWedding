 ...
 * Generated at: 2019-12-22 03:59:50 UTC
...
request.setCharacterEncoding("utf-8");
	...
	String dirPath="assets";
      ...
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"1-hunshataoxi.jsp\">婚纱套系</a>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0)\">修改职工信息</a>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h3 class=\"lighter block blue\">修改该职工信息</h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<form class=\"form-horizontal \"  action=\"StaffUpdateServlet\" id=\"validation-form\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"sid\" id=\"sid\" class=\"col-xs-12 col-sm-3\"  readonly=\"readonly\" value=\"");
      out.print(s.getsId());
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"sname\" id=\"sname\" class=\"col-xs-12 col-sm-3\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"sage\" id=\"sage\" class=\"col-xs-12 col-sm-3\" value=\"");
      out.print(s.getsAge());
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 col-sm-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"clearfix\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"ssex\" id=\"ssex\" class=\"col-xs-12 col-sm-3\" value=\"");
      out.print(s.getsSex());
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"spost\" name=\"spost\" class=\"col-xs-12 col-sm-2\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"sphone\" name=\"sphone\" class=\"col-xs-12 col-sm-2\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"swage\" name=\"swage\" class=\"col-xs-12 col-sm-2\" value=\"");
